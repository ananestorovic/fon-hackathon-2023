...
enum Condition { Adoption, Disappear, PetSitting }
...
class Pet {
  ...
  static List<Pet> getPetListDefault() {
    return <Pet>[
      ...
      Pet("American Shorthair", "Washintong", "1.2", "Pet-Sitting",
          Category.CAT, "assets/images/cats/cat_5.jpg", true, false),
      ...
      Pet("Ruso", "New Jersey", "2.5", "Pet-Sitting", Category.HAMSTER,
      ...
      Pet("Dwarf Winter", "Miami", "2.5", "Pet-Sitting", Category.HAMSTER,
      ...
      Pet("Belgian Hare Rabbit", "New Jersey", "2.5", "Pet-Sitting",
          Category.BUNNY, "assets/images/bunnies/bunny_2.jpg", false, false),
      ...
      Pet("English Lop", "Miami", "2.5", "Pet-Sitting", Category.BUNNY,
      ...
      Pet("Akita Shepherd", "New Jersey", "2.5", "Pet-Sitting", Category.DOG,
      ...
      Pet("Belgian Sheepdog", "Miami", "2.5", "Pet-Sitting", Category.DOG,
      ...
      Pet("Chinese Shar-Pei", "New Jersey", "2.5", "Pet-Sitting", Category.DOG,
